  ...
  describe("Default user", () => {
    ...
    test("With nonexistent session", async () => {
      const nonexistentToken =
        "d4cc3942d16ca32d74064be3f74d593faa2d991b66ed13801f99fe6d1ae112303f771a9ff9d43589bd3b778826632984";
    ...
    test("with valid session in midlife", async () => {
      jest.useFakeTimers({
        now: new Date(Date.now() - session.EXPIRATION_IN_MILLISECONDS / 2),
      });

      const createdUser = await orchestrator.createUser({
        username: "MidlifeSession",
      });
      ...
      expect(
        session.EXPIRATION_IN_MILLISECONDS - expirationTimeInMillisseconds,
      ).toBeLessThan(1000);
